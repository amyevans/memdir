		...
		<div class="inner-page-wrap <?php echo $page_wrap_class; ?> clearfix">
			...
			<div <?php post_class('clearfix ' . $post_class_extra); ?> id="<?php the_ID(); ?>">
				...
				<div class="page-content clearfix">
					<?php if (get_the_ID() != 12355) { 
						the_content();
					}
					else{
						include get_template_directory() . '/includes/member-directory.php';
					} ?>
			...
			<?php if(is_user_logged_in() or ($post->ID != 12729 and $post->post_parent != 12729)): ?>
