...
if(!$result){
	...
	foreach ($result as $member) {
		...
		<tr <?php echo $show; ?>>					
			...
			&nbsp;&nbsp; <img src="<?php bloginfo('template_directory'); ?>/images/p.png" alt="<?php echo $member->WORK_PHONE; ?> " height="22" width="23"> <?php echo $member->WORK_PHONE; ?>  |  <?php echo $member->FAX; ?></td>
		</tr>
